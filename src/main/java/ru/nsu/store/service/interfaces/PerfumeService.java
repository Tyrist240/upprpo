...
public interface PerfumeService {
    ...
    List<Perfume> filter(List<String> perfumers, List<String> genders, List<Integer> prices, boolean sortByPrice, List<Integer> years, List<String> volumes, List<String> types);
