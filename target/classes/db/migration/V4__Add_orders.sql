...
VALUES (1, 'Wall Street1', 'New York', '2022-05-07', 'test123@test.com', 'John', 'Doe', '1234567890', 1234567890, 840);
INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price)
VALUES (2, 'Wall Street1', 'New York', '2022-05-07', 'test123@test.com', 'John', 'Doe', '1234567890', 1234567890, 240);
INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price)
VALUES (3, 'Tverskaya street 1', 'Moscow', '2022-05-07', 'ivan123@test.com', 'Ivan', 'Ivanov', '1234567890', 1234567890, 163);
INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price)
VALUES (4, 'Tverskaya street 1', 'Moscow', '2022-05-07', 'ivan123@test.com', 'Ivan', 'Ivanov', '1234567890', 1234567890, 780);
INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price)
VALUES (5, 'Tverskaya street 1', 'Moscow', '2022-05-07', 'ivan123@test.com', 'Ivan', 'Ivanov', '1234567890', 1234567890, 196);
